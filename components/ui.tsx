...
export function Icon({ name, size = 21, color = colors.text }: { name: IconName; size?: number; color?: string }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      ...
      {name === 'sliders' && (
        <>
          <Path d="M4 7h9M17 7h3" {...p} />
          <Circle cx={15} cy={7} r={2.1} {...p} />
          <Path d="M4 12h3M11 12h9" {...p} />
          <Circle cx={9} cy={12} r={2.1} {...p} />
          <Path d="M4 17h9M17 17h3" {...p} />
          <Circle cx={15} cy={17} r={2.1} {...p} />
        </>
      )}
      ...
      {name === 'lock' && (
        <>
          <Rect x={5} y={11} width={14} height={9} rx={2.4} {...p} />
